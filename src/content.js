export const copy = {
  zh: {
    ...
    missionTitle: '巡回五座项目终端',
    missionCopy: '沿稳定斜俯视路线驾驶，依次连接五座赛博朋克项目终端。',
    drive: '驾驶',
    boost: '推进',
    brake: '漂移 / 刹车',
    jump: '跃起',
  ...
  en: {
    status: 'RAIN LINK // ONLINE',
    missionTitle: 'Tour five project terminals',
    missionCopy: 'Drive the stable isometric route and connect all five cyberpunk project terminals.',
    drive: 'Drive',
    boost: 'Boost',
    brake: 'Drift / brake',
    jump: 'Jump',
